...
const RoleIcon = ({ icon, className = "w-6 h-6" }) => {
    const icons = {
        mern: (
        ...
        link: (
            <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.826a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
            </svg>
        ),
        mobile: (
            <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
